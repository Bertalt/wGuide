...
public class MapsActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO: Отказаться от широковещательных сообщений
 ...
 */
    ...
    private MarkerOptions newMarkerMyPosition (LatLng mCurrentPosition)     //set up marker current position
    {
        return new MarkerOptions()
             ...
             /*
             Функция завершения программы при быстром нажатии на back
              */
             @Override
             ...
             public class RunServiceWithTimer implements Runnable{
                 /*
                 Переодически запускаю сервис сканирования
                  */
                 @Override
                 public void run() {
                     {
                 ...
                 public void onGpsStatusChanged(int event) {
                     handler.post(new Runnable() {
                         public void run() {
                             ...
                             int timetofix = lm.getGpsStatus(null).getTimeToFirstFix();//время на подключение к достат. кол-ву спутников
